...
apk add --update build-base sqlite postgresql-dev openssl gdbm libpq python2-dev perl-dev mariadb-connector-c-dev unixodbc-dev krb5-dev wxgtk2.8-dev openldap-dev gdbm-dev && \
